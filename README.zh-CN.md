...
> 🏅 **Open Design Fellow 计划已开放。** 如果你也相信设计该是开放的——欢迎成为 Open Design Fellow，和核心团队一起塑造产品，让设计不再被少数工具垄断。详情 → [MAINTAINERS.md](MAINTAINERS.md) 与 [Discord](https://discord.gg/qhbcCH8Am4)。

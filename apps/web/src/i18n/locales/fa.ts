...
export const fa: Dict = {
  ...
  'settings.cliEnvCodexBaseUrl': 'Proxy base URL',
  'settings.cliEnvCodexApiKey': 'Proxy API key',
  ...
  'settings.memoryModelInlineHintCli': 'Uses your Local CLI when supported; pick a model to override.',
  'settings.memoryModelInlineHintCliConstrained': 'Uses your Local CLI when supported; {provider} is the fallback.',
  'settings.memoryModelInlineHintByok': 'Reuses your chat API key; pick a cheaper model to save cost.',

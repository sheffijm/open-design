...
export const fa: Dict = {
  ...
  'settings.amrLoginReasonBinaryMissing': 'مؤلفهٔ ورود موجود نیست. Open Design را مجدداً راه‌اندازی یا نصب کنید.',
  'settings.amrLoginReasonSpawnFailed': 'فرایند ورود آغاز نشد. لطفاً دوباره تلاش کنید.',
  'settings.amrLoginReasonNetwork': 'مشکل شبکه — دسترسی به سرویس ورود ممکن نشد. اتصال خود را بررسی کرده و دوباره تلاش کنید.',
  'settings.amrLoginReasonProxyBlocked': 'یک پروکسی یا VPN مانع ورود شد. آن را خاموش کرده و دوباره تلاش کنید.',
  'settings.amrLoginReasonTimeout': 'مهلت ورود به پایان رسید. دوباره وارد شوید.',
  'settings.amrLoginReasonInterrupted': 'ورود قطع شد. لطفاً دوباره وارد شوید.',

...
export const zhCN: Dict = {
  ...
  "settings.amrLoginReasonBinaryMissing": "登录组件缺失，请重启或重新安装 Open Design。",
  "settings.amrLoginReasonSpawnFailed": "无法启动登录进程，请重试。",
  "settings.amrLoginReasonNetwork": "网络异常，暂时无法连接登录服务，请检查网络后重试。",
  "settings.amrLoginReasonProxyBlocked": "代理或 VPN 拦截了登录请求，请关闭后重试。",
  "settings.amrLoginReasonTimeout": "登录超时，请重新发起登录。",
  "settings.amrLoginReasonInterrupted": "登录被中断，请重新登录。",

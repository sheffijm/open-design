...
export const zhCN: Dict = {
  ...
  'settings.modelPickerPullLive': '拉取实时模型',
  ...
  'settings.cliEnvHint':
    '仅在使用自有代理或非标准安装路径时需要。仅本地保存，且只对当前 CLI 生效。',
  'settings.cliEnvClaudeConfigDir': '配置目录',
  'settings.cliEnvClaudeBaseUrl': '代理 Base URL',
  'settings.cliEnvClaudeApiKey': '代理 API Key',
  'settings.cliEnvCodexHome': '配置目录',
  'settings.cliEnvCodexBin': '可执行文件路径',
  'settings.cliEnvCodexBaseUrl': '代理 Base URL',
  'settings.cliEnvCodexApiKey': '代理 API Key',
  ...
  'settings.memoryModelInlineHintCli': '支持时使用当前 Local CLI；如需覆盖可选择具体模型。',
  'settings.memoryModelInlineHintCliConstrained': '支持时使用当前 Local CLI；{provider} 仅作为回退。',
  'settings.memoryModelInlineHintByok': '复用聊天的 API Key；可选更便宜的模型以节省成本。',
  ...
  'settings.healthcheck.latency': '实测连通 {value}',
  'settings.healthcheck.details': '检查详情',
  'settings.healthcheck.overall.pass': '配置正常，可以使用',
  'settings.healthcheck.overall.warn': '可以使用，但有小问题',
  'settings.healthcheck.overall.fail': '暂时无法使用，需修复',
  'settings.healthcheck.check.detected': '安装',
  'settings.healthcheck.check.invocable': '启动',
  'settings.healthcheck.check.authenticated': '登录',
  'settings.healthcheck.check.smoke': '实测对话',
};

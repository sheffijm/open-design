...
export const zhCN: Dict = {
  ...
  'chat.runError.title.modelUnavailable': '模型暂不可用',
  'chat.runError.title.promptTooLarge': '输入内容过长',
  'chat.runError.title.upstreamUnavailable': '服务暂时不可用',
  'chat.runError.title.timeout': '生成超时',
  'chat.runError.title.emptyOutput': '没有返回内容',
  'chat.runError.title.toolError': '工具执行失败',
  'chat.runError.title.processExit': '生成进程意外退出',
  'chat.runError.title.userCancel': '已取消本次运行',
  'chat.runError.reason.rateLimit': '服务方正在限流，请稍等片刻再重试。',
  'chat.runError.reason.modelUnavailable': '所选模型暂时不可用，切换模型通常即可继续。',
  'chat.runError.reason.promptTooLarge': '本次输入超出了模型的上下文上限，请精简或拆分后再试。',
  'chat.runError.reason.upstreamUnavailable': '上游服务暂时中断，通常很快会恢复。',
  'chat.runError.reason.timeout': '本次运行耗时过长，未完成即超时。',
  'chat.runError.reason.emptyOutput': '模型没有返回可用内容，重试或切换模型通常能解决。',
  'chat.runError.reason.toolError': '某个工具执行失败——可能是临时故障，也可能是配置问题。',
  'chat.runError.reason.processExit': '生成进程意外退出，重试通常即可恢复。',
  'chat.runError.reason.userCancel': '你取消了本次运行。',
  'chat.runError.reason.unknown': '本次运行因未知原因失败。',
  'chat.runError.expectation.retry': '将以相同输入重新运行。',
  'chat.runError.expectation.reduceContext': '删减部分内容后继续，或拆分为更小的任务。',
  'chat.runError.expectation.switchModel': '选择其他模型以继续。',
  'chat.runError.expectation.login': '将打开登录页面，登录后会回到当前任务。',

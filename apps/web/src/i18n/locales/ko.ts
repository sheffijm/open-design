...
export const ko: Dict = {
  ...
  'chat.runError.title.timeout': 'Generation timed out',
  'chat.runError.title.emptyOutput': 'No output returned',
  'chat.runError.title.toolError': 'A tool failed',
  'chat.runError.title.processExit': 'Process exited unexpectedly',
  'chat.runError.title.userCancel': 'Run canceled',
  'chat.runError.reason.rateLimit': 'The provider is rate-limiting requests right now — wait a moment, then try again.',
  'chat.runError.reason.modelUnavailable': 'The selected model is temporarily unavailable. Switching models usually lets you continue.',
  'chat.runError.reason.promptTooLarge': 'This input exceeds the model\'s context limit. Trim or split it, then try again.',
  'chat.runError.reason.upstreamUnavailable': 'An upstream service is temporarily down. It usually recovers in a short while.',
  'chat.runError.reason.timeout': 'This run took too long and timed out before finishing.',
  'chat.runError.reason.emptyOutput': 'The model returned no usable content. Retrying or switching models usually helps.',
  'chat.runError.reason.toolError': 'One of the tools failed to run — this can be a temporary glitch or a configuration issue.',
  'chat.runError.reason.processExit': 'The generation process exited unexpectedly. Retrying usually recovers it.',
  'chat.runError.reason.userCancel': 'You canceled this run.',
  'chat.runError.reason.unknown': 'This run failed for an unexpected reason.',
  'chat.runError.expectation.retry': 'Re-runs with the same input.',
  'chat.runError.expectation.reduceContext': 'Continue after removing some content, or split it into smaller tasks.',
  'chat.runError.expectation.switchModel': 'Pick another model to continue.',
  'chat.runError.expectation.login': 'Opens the sign-in page; you\'ll return to this task afterward.',

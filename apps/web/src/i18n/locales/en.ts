...
export const en: Dict = {
  ...
  'settings.amrLoginReasonBinaryMissing': 'The sign-in component is missing. Restart or reinstall Open Design.',
  'settings.amrLoginReasonSpawnFailed': 'Couldn’t start the sign-in process. Please try again.',
  'settings.amrLoginReasonNetwork': 'Network problem — couldn’t reach the sign-in service. Check your connection and retry.',
  'settings.amrLoginReasonProxyBlocked': 'A proxy or VPN blocked sign-in. Turn it off and retry.',
  'settings.amrLoginReasonTimeout': 'Sign-in timed out. Start sign-in again.',
  'settings.amrLoginReasonInterrupted': 'Sign-in was interrupted. Please sign in again.',

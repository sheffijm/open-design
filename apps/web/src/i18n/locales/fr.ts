...
export const fr: Dict = {
  ...
  'settings.modelPickerPullLive': 'Pull live models',
  ...
  'settings.cliEnvHint': 'Uniquement pour un proxy personnalisé ou un chemin d’installation non standard. Stocké en local, utilisé uniquement par ce CLI.',
  'settings.cliEnvClaudeConfigDir': 'Répertoire de configuration',
  'settings.cliEnvClaudeBaseUrl': 'URL de base du proxy',
  'settings.cliEnvClaudeApiKey': 'Clé API du proxy',
  'settings.cliEnvCodexHome': 'Répertoire de configuration',
  'settings.cliEnvCodexBin': 'Chemin de l’exécutable',
  'settings.cliEnvCodexBaseUrl': 'URL de base du proxy',
  'settings.cliEnvCodexApiKey': 'Clé API du proxy',
  ...
  'settings.memoryModelInlineHintCli': 'Utilise votre CLI local quand c’est pris en charge ; choisissez un modèle pour remplacer.',
  'settings.memoryModelInlineHintCliConstrained': 'Utilise votre CLI local quand c’est pris en charge ; {provider} sert de repli.',
  'settings.memoryModelInlineHintByok': 'Réutilise la clé API du chat ; choisissez un modèle moins cher pour économiser.',
  ...
  'settings.healthcheck.latency': 'Live reply in {value}',
  'settings.healthcheck.details': 'Check details',
  'settings.healthcheck.overall.pass': 'Ready to use',
  'settings.healthcheck.overall.warn': 'Works, with minor issues',
  'settings.healthcheck.overall.fail': 'Not working yet',
  'settings.healthcheck.check.detected': 'Installed',
  'settings.healthcheck.check.invocable': 'Launch',
  'settings.healthcheck.check.authenticated': 'Sign-in',
  'settings.healthcheck.check.smoke': 'Live test',
};

...
export const zhTW: Dict = {
  ...
  "settings.amrLoginReasonBinaryMissing": "登入元件遺失，請重新啟動或重新安裝 Open Design。",
  "settings.amrLoginReasonSpawnFailed": "無法啟動登入程序，請再試一次。",
  "settings.amrLoginReasonNetwork": "網路異常，暫時無法連線登入服務，請檢查網路後重試。",
  "settings.amrLoginReasonProxyBlocked": "代理或 VPN 攔截了登入要求，請關閉後重試。",
  "settings.amrLoginReasonTimeout": "登入逾時，請重新發起登入。",
  "settings.amrLoginReasonInterrupted": "登入已中斷，請重新登入。",

...
export const zhTW: Dict = {
  ...
  'settings.modelPickerPullLive': '拉取即時模型',
  ...
  'settings.cliEnvHint':
    '僅在使用自有代理或非標準安裝路徑時需要。僅本機保存，且只對目前 CLI 生效。',
  'settings.cliEnvClaudeConfigDir': '設定目錄',
  'settings.cliEnvClaudeBaseUrl': '代理 Base URL',
  'settings.cliEnvClaudeApiKey': '代理 API Key',
  'settings.cliEnvCodexHome': '設定目錄',
  'settings.cliEnvCodexBin': '可執行檔路徑',
  ...
  'settings.memoryModelInlineHintCli': '支援時使用目前 Local CLI；如需覆寫可選擇特定模型。',
  'settings.memoryModelInlineHintCliConstrained': '支援時使用目前 Local CLI；{provider} 僅作為回退。',
  'settings.memoryModelInlineHintByok': '沿用聊天的 API Key；可選更便宜的模型以節省成本。',
  ...
  'settings.healthcheck.latency': '實測連通 {value}',
  'settings.healthcheck.details': '檢查詳情',
